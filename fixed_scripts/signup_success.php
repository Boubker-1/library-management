        ...
        <div class = "custom-card-width">
            <div class="card">
                <div class="d-flex justify-content-between">
                    <button class="btn btn-outline-info w-50 active" id="signup-toggle">Sign Up</button>
                    <button class="btn btn-outline-info w-50 disabled" id="login-toggle">Log In</button>
                </div>
                <div class="card-body">
                    <div id="signup-form">
                        <!-- Sign Up Form -->
