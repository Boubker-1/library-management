        ...
        <div class = "custom-card-width">
            <div class="card">
                <div class="d-flex justify-content-between">
                    <button class="btn btn-outline-info w-50" id="signup-toggle" onclick="toggleForm('signup')">Sign Up</button>
                    <button class="btn btn-outline-info w-50 active" id="login-toggle" onclick="toggleForm('login')">Log In</button>
                </div>
                <div class="card-body">
