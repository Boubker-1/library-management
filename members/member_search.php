	...
	<div class="container mt-5">
	    <div class="row">
	        <div class="col">
	            ...
	            <form class="form-inline float-right" action="member_search.php" method="GET">
	                <input class="form-control mr-sm-2" type="search" placeholder="Search by member name" aria-label="Search" name="searchTerm">
	    ...
	    <div class="row mt-3">
	        <div class="col">
	            <div class="button-container">
	                <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#addMemberModal">Add a new member</button>
	            </div>
	        </div>
	    </div>
		        ...
		        <tbody>
		            <?php
		            	if (isset($_GET['searchTerm'])) {
		            		...
		            		$sql = "SELECT * FROM members WHERE name LIKE '%" . $searchTerm . "%'";
		            	}
		            	else {
